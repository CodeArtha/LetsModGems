...
public class ItemPortableBed extends ItemOP
{
    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entityPlayer)
    {
        if(world.provider.canRespawnHere())
        {
            ...
            entityPlayer.addChatMessage( new ChatComponentText( "Your spawn has been set to:" + chunkcoordinates.posX + ", " + chunkcoordinates.posZ + "." ) );
        }

        return itemStack;
    }

    public boolean onItemUse(ItemStack itemStack, EntityPlayer entityPlayer, World world, int j, int k, int l, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        if (world.isRemote)
        {
            return true;
