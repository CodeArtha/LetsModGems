...
public class BlockLongDoor extends BlockOP
{
    ...
    public BlockLongDoor(Material material)
    {
        super(material);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    {
        return y < world.getHeight() - 1 && World.doesBlockHaveSolidTopSurface( world, x, y - 1, z ) && super.canPlaceBlockAt( world, x, y, z )
     ...
     */
    public void onBlockHarvested(World world, int x, int y, int z, int p_149681_5_, EntityPlayer entityPlayer)
    {
        if (entityPlayer.capabilities.isCreativeMode && (p_149681_5_ & 8) != 0 && world.getBlock(x, y - 1, z) == this)
        {
