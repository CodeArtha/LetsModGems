    ...
    implements IProjectile
{
    ...
    public EntityQuarrel( World world )
    {
        super( world );
    ...
    public EntityQuarrel( World world, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_ )
    {
        super( world );
        this.renderDistanceWeight = 10.0D;
        this.setSize( 0.5F, 0.5F );
    ...
    public EntityQuarrel( World world, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_ )
    {
        super( world );
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityQuarrel( World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_ )
    {
        super( p_i1756_1_ );
        this.renderDistanceWeight = 10.0D;
    ...
    public void setVelocity( double x, double y, double z )
    {
        ...
        if ( this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F )
        {
            ...
            this.prevRotationYaw = this.rotationYaw = (float) ( Math.atan2( y, z ) * 180.0D / Math.PI );
    ...
    public void onUpdate()
    {
        ...
        if ( this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F )
        {
            ...
            this.prevRotationYaw = this.rotationYaw = (float) ( Math.atan2( this.motionY, this.motionZ ) * 180.0D / Math.PI );
        ...
        else
        {
            ...
            Entity entity = null;
            List list = this.worldObj.getEntitiesWithinAABBExcludingEntity( this, this.boundingBox.addCoord( this.motionX, this.motionY,
            ...
            if ( movingobjectposition != null )
            {
                if ( movingobjectposition.entityHit != null )
                {
                    ...
                    {
                        damagesource = causeQuarrelDamage( this, this );
                    }
                    else
                    {
                        damagesource = causeQuarrelDamage( this, this.shootingEntity );
                    }
                            ...
                            if ( this.knockbackStrength > 0 )
                            {
                                ...
                                if ( f4 > 0.0F )
                                {
                                    movingobjectposition.entityHit.addVelocity(
                                        this.motionX * (double) this.knockbackStrength * 0.6000000238418579D / (double) f4, 0.1D,
            ...
            if ( this.isInWater() )
            {
                ...
                {
                    f4 = 0.25F;
                    this.worldObj.spawnParticle( "bubble", this.posX - this.motionX * (double) f4, this.posY - this.motionY * (double) f4,
     ...
     */
    public static DamageSource causeQuarrelDamage( EntityQuarrel entityquarrel, Entity entity )
    {
        return ( new EntityDamageSourceIndirect( "quarrel", entityquarrel, entity ) ).setProjectile();
    }
}
